...
label_first_name.grid(row=0,column=1,padx=10,pady=5,sticky="w")
label_last_name.grid(row=1,column=1,padx=10,pady=5,sticky="w")
label_email.grid(row=2,column=1,padx=10,pady=5,sticky="w")
label_contact_number.grid(row=3,column=1,padx=10,pady=5,sticky="w")
label_password.grid(row=4,column=1,padx=10,pady=5,sticky="w")
